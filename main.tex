...
\begin{tcolorbox}[colback=greenish!20!white,colframe=white,arc=8pt,outer arc=8pt]
    \textbf{\textsf{Properties of Gaussian function:}}\\[5pt]
    Gaussian function/Normal distribuition has several nice properties making them amenable for a variety of analytical calculations. The function is defined as,
    \[
    g(x)={\frac{1}{{\sqrt {2\pi \sigma^2}}}}\exp \left[-{\frac {1}{2}}{\frac {(x-\mu )^{2}}{\sigma ^{2}}}\right].
    \]
    The mean of the function/distribution, $\E[x] = \mu$ and the variance,
